...
export default class PaymentRequest {
  ...
  _handleUserAccept(details: {
    ...
    return this._accept._acceptPromiseResolver(paymentResponse);
  }

  _handleGatewayError(details: { error: string }) {
    return this._accept._acceptPromiseRejecter(new GatewayError(details.error));
  }

  _closePaymentRequest() {
    this._state = "closed";

    this._accept._acceptPromiseRejecter(new Error("AbortError"));
  ...
  show(): Promise<PaymentResponseType> {
    const self = this;
    this._accept._acceptPromise = new Promise((resolve, reject) => {
      self._accept._acceptPromiseResolver = resolve;
      self._accept._acceptPromiseRejecter = reject;
    ...
    return this._accept._acceptPromise;
  }
