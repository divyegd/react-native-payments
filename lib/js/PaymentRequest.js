...
const _acceptPromise: Promise<any> = null;
const _acceptPromiseResolver: (value: any) => void = null;
const _acceptPromiseRejecter: (reason: any) => void = null;
...
export default class PaymentRequest {
  ...
  _handleGatewayError(details: { error: string }) {
    return _acceptPromiseRejecter(new GatewayError(details.error));
  }
  ...
  show(): Promise<PaymentResponseType> {
    const self = this;
    _acceptPromise = new Promise((resolve, reject) => {
